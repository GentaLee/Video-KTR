...
class HandoffSyncTests(unittest.TestCase):
    def setUp(self):
        ...
        self.g("switch", "-c", "test/multimodal-ktr-h200")
        ...
        self.g("switch", "-c", "test/multimodal-ktr-b200")
        ...
        self.g("switch", "test/multimodal-ktr-h200")
    ...
    def test_peer_snapshot_only_commit_does_not_create_sync_loop(self):
        ...
        self.g("switch", "test/multimodal-ktr-b200")
